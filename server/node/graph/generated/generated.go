...
type ComplexityRoot struct {
	Entity struct {
		FindNodeByNodeID func(childComplexity int, nodeID string) int
	}

	Mutation struct {
		UpNode func(childComplexity int, node model.NodeInput) int
	}
...
type EntityResolver interface {
	FindNodeByNodeID(ctx context.Context, nodeID string) (*model.Node, error)
}
type MutationResolver interface {
	UpNode(ctx context.Context, node model.NodeInput) (*model.Node, error)
}
type QueryResolver interface {
	Node(ctx context.Context, nodeID string) (*model.Node, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Entity.findNodeByNodeID":
		if e.complexity.Entity.FindNodeByNodeID == nil {
			break
		}

		args, err := ec.field_Entity_findNodeByNodeID_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Entity.FindNodeByNodeID(childComplexity, args["nodeID"].(string)), true

	case "Mutation.upNode":
		if e.complexity.Mutation.UpNode == nil {
			break
		}

		args, err := ec.field_Mutation_upNode_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Mutation.UpNode(childComplexity, args["node"].(model.NodeInput)), true
...
var sources = []*ast.Source{
	{Name: "../../../graphql-router/graphql/node.graphql", Input: `extend schema @link(url: "https://specs.apollo.dev/federation/v2.0", import: ["@key", "@shareable"])
...
type Entity {
		findNodeByNodeID(nodeID: ID!,): Node!
...
func (ec *executionContext) field_Entity_findNodeByNodeID_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
...
func (ec *executionContext) field_Mutation_upNode_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
...
func (ec *executionContext) _Entity_findNodeByNodeID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Entity_findNodeByNodeID(ctx, field)
	if err != nil {
		return graphql.Null
	}
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Entity().FindNodeByNodeID(rctx, fc.Args["nodeID"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_Entity_findNodeByNodeID(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Entity_findNodeByNodeID_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return
	}
	return fc, nil
...
func (ec *executionContext) _Mutation_upNode(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Mutation_upNode(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpNode(rctx, fc.Args["node"].(model.NodeInput))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_Mutation_upNode(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Mutation_upNode_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return
	}
	return fc, nil
...
func (ec *executionContext) unmarshalInputNodeInput(ctx context.Context, obj interface{}) (model.NodeInput, error) {
	...
	fieldsInOrder := [...]string{"name", "nodeId"}
	...
	for i, field := range fields {
		...
		case "findNodeByNodeID":
			...
			innerFunc := func(ctx context.Context) (res graphql.Marshaler) {
				...
				res = ec._Entity_findNodeByNodeID(ctx, field)
				if res == graphql.Null {
	...
	for i, field := range fields {
		...
		case "upNode":
			...
			out.Values[i] = ec.OperationContext.RootResolverMiddleware(innerCtx, func(ctx context.Context) (res graphql.Marshaler) {
				return ec._Mutation_upNode(ctx, field)
			})
