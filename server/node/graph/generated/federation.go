...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		case "Node":
			...
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Node": %w`, err)
			}
			switch resolverName {

			case "findNodeByNodeID":
				id0, err := ec.unmarshalNID2string(ctx, rep["nodeID"])
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findNodeByNodeID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindNodeByNodeID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Node": %w`, err)
				}
...
func entityResolverNameForNode(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
		...
		return "findNodeByNodeID", nil
	}
	return "", fmt.Errorf("%w for Node", ErrTypeNotFound)
}
