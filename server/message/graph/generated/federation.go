...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		case "Message":
			...
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Message": %w`, err)
			}
			switch resolverName {

			case "findMessageByMessageID":
				id0, err := ec.unmarshalNID2string(ctx, rep["messageID"])
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findMessageByMessageID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindMessageByMessageID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Message": %w`, err)
				}
...
func entityResolverNameForMessage(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
		...
		return "findMessageByMessageID", nil
	}
	return "", fmt.Errorf("%w for Message", ErrTypeNotFound)
}
